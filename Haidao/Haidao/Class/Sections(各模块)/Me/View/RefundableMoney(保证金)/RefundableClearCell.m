...
@implementation RefundableClearCell

+ (RefundableClearCell *)cellWithTableView:(UITableView *)tableView {
    static NSString *ID = @"RefundableClearCell";
    RefundableClearCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[RefundableClearCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
    }
    return cell;
}
