...
@interface RefundableReturnCell ()
...
@implementation RefundableReturnCell

+ (RefundableReturnCell *)cellWithTableView:(UITableView *)tableView {
    static NSString *ID = @"RefundableReturnCell";
    RefundableReturnCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[RefundableReturnCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
