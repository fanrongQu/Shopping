...
@interface PunctualityProfitsCell ()
...
@implementation PunctualityProfitsCell

+ (PunctualityProfitsCell *)cellWithTableView:(UITableView *)tableView {
    static NSString *ID = @"PunctualityProfitsCell";
    PunctualityProfitsCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[PunctualityProfitsCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
