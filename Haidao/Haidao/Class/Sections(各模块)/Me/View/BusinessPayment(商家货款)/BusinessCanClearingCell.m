...
@interface BusinessCanClearingCell ()
...
@implementation BusinessCanClearingCell

+ (BusinessCanClearingCell *)cellWithTableView:(UITableView *)tableView {
    static NSString *ID = @"BusinessCanClearingCell";
    BusinessCanClearingCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[BusinessCanClearingCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
