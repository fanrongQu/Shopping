...
@implementation MerchantOutputCell

+ (MerchantOutputCell *)cellWithTableView:(UITableView *)tableView {
    static NSString *ID = @"MerchantOutputCell";
    MerchantOutputCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[MerchantOutputCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
