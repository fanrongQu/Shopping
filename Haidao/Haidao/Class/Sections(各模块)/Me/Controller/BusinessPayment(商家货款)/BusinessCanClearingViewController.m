//
//  BusinessCanClearingViewController.m
//  Haidao
//
...
#import "BusinessCanClearingCell.h"
#import "FilterView.h"

@interface BusinessCanClearingViewController ()<UITableViewDelegate,UITableViewDataSource,FilterViewDelegate>
...
@implementation BusinessCanClearingViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BusinessCanClearingCell *cell = [BusinessCanClearingCell cellWithTableView:tableView];
    [cell setSerialNumber:@"1000000020" type:self.title money:@"100" remarks:@"消费收入货款" time:@"2016-8-2 22:01"];
...
- (UILabel *)currentIntegralText {
    if (!_currentIntegralText) {
        ...
        _currentIntegralText.text = @"货款收入总额";
