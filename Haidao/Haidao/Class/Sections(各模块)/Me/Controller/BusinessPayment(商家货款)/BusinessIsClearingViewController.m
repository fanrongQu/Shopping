//
//  BusinessIsClearingViewController.m
//  Haidao
//
...
@interface BusinessIsClearingViewController ()<UITableViewDelegate,UITableViewDataSource,FilterViewDelegate>
...
@implementation BusinessIsClearingViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BusinessIsClearingCell *cell = [BusinessIsClearingCell cellWithTableView:tableView];
    
    [cell setBusinessIsClearingOfSerialNumber:@"111111123" applyMoney:@"1000" clearingType:@"货款结算" applyTime:@"2016-7-29 10:00" bankCard:@"622787******7865" remark:@"结算货款" time:@"2016-8-2 11:34" status:YES];
...
- (UILabel *)currentIntegralText {
    if (!_currentIntegralText) {
        ...
        _currentIntegralText.text = @"已结算货款";
