...
@interface MerchantRechargeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MerchantRechargeCell *cell = [MerchantRechargeCell cellWithTableView:tableView];
    
    [cell setSerialNumber:@"1000000020" type:@"农行充值" money:@"100" remarks:@"赠送积分" time:@"2016-8-2 22:01"];
...
- (UILabel *)currentIntegralText {
    if (!_currentIntegralText) {
        ...
        _currentIntegralText.text = @"充值让利额";
