//
//  RefundableClearViewController.m
//  Haidao
//
...
#import "RefundableClearCell.h"
#import "FilterView.h"

@interface RefundableClearViewController ()<UITableViewDelegate,UITableViewDataSource,FilterViewDelegate>
...
@implementation RefundableClearViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    RefundableClearCell *cell = [RefundableClearCell cellWithTableView:tableView];
    
    [cell setRefundableClearOfSerialNumber:@"111111123" applyMoney:@"1000" clearingType:@"保证金结算" applyTime:@"2016-7-29 10:00" bankCard:@"622787******7865" remark:@"结算保证金" time:@"2016-8-2 11:34" status:NO];
...
- (UILabel *)currentIntegralText {
    if (!_currentIntegralText) {
        ...
        _currentIntegralText.text = @"已结算保证金";
