...
@interface ReceiveListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ReceiveListCell *cell = [ReceiveListCell cellWithTableView:tableView];
    
    [cell setReceiveListOfSerialNumber:@"123432121" type:@"现金购买" consumerName:@"刘德华" commodity:@"纯净水" expendMoney:@"￥1000.00" cuttingProfits:@"100.00" time:@"2016-8-2 11:34" status:YES];
...
- (UILabel *)currentIntegralText {
    if (!_currentIntegralText) {
        ...
        _currentIntegralText.text = @"获赠积分";
