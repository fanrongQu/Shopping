...
@interface PresentListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation PresentListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    PresentListCell *cell = [PresentListCell cellWithTableView:tableView];
...
- (UILabel *)currentIntegralText {
    if (!_currentIntegralText) {
        ...
        _currentIntegralText.text = @"赠出积分";
