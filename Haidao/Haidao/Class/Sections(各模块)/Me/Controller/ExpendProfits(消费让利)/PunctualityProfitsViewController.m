//
//  PunctualityProfitsViewController.m
//  Haidao
//
...
#import "PunctualityProfitsCell.h"

@interface PunctualityProfitsViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation PunctualityProfitsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    PunctualityProfitsCell *cell = [PunctualityProfitsCell cellWithTableView:tableView];
    [cell setSerialNumber:@"1000000020" type:self.title money:@"100" remarks:@"定返让利额" time:@"2016-8-2 22:01"];
...
- (UILabel *)currentIntegralText {
    if (!_currentIntegralText) {
        ...
        _currentIntegralText.text = @"定返让利总额";
