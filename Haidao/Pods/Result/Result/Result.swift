...
public func ?? <T, Error> (left: Result<T, Error>, right: @autoclosure () -> T) -> T {
	return left.recover(right())
}

/// Returns `left` if it is a `Success`es, or `right` otherwise. Short-circuits.
public func ?? <T, Error> (left: Result<T, Error>, right: @autoclosure () -> Result<T, Error>) -> Result<T, Error> {
...
public func >>- <T, U, Error> (result: Result<T, Error>, transform: (T) -> Result<U, Error>) -> Result<U, Error> {
